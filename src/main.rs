...
fn gray_scale(img: &mut image::ImageBuffer<image::Rgb<u8>, Vec<u8>>) {
...
fn reflect(img: &mut image::ImageBuffer<image::Rgb<u8>, Vec<u8>>) {
...
fn blur(img: &mut image::ImageBuffer<image::Rgb<u8>, Vec<u8>>) {
    println!("{}", img.width());

    for y in 1..img.height() - 1 {
        for x in 1..img.width() - 1 {
            if x + 3 < img.width() && y + 3 < img.height() {
...
fn edges(img: &mut image::ImageBuffer<image::Rgb<u8>, Vec<u8>>) {
...
fn edges_view(img: &mut image::ImageBuffer<image::Rgb<u8>, Vec<u8>>) {
        ...
        for x in 1..img.width() - 1 {
            ...
            image_copy
                ...
                .for_each(|(tx, ty, pixel)| {
                    ...
                    gradient_x_green += (gradient_x[tmp_x][tmp_y] * values[1] as i16) as i32;
                    ...
                    gradient_y_green += (gradient_y[tmp_x][tmp_y] * values[1] as i16) as i32;
